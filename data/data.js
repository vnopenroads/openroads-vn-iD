iD.data = {
    ...
    "en": {
        ...
        "commit": {
            ...
            "upload_explanation": "The changes you upload will be visible on the OpenRoads platform.",
            "upload_explanation_with_user": "The changes you upload as {user} will be visible on the OpenRoads platform.",
            "save": "Save",
            "cancel": "Cancel",
        ...
        "splash": {
            "welcome": "Welcome to the iD OpenRoads editor",
        ...
        "validations": {
            ...
            "many_deletions": "You're deleting {n} objects. Are you sure you want to do this? This will delete them from the map that everyone else sees on OpenRoads.",
        ...
        "help": {
            "title": "Help",
            "help": "# Help\n\nThis is an editor for [OpenRoads](http://www.openroads.ph/). You can\nuse it to add and update road network data from the Philippines.\n\nEdits that you make on this map will be visible to everyone who uses\nOpenRoads. In order to make an edit, you'll need a\n[free OpenStreetMap account](https://www.openstreetmap.org/user/new).\n\nThe [iD editor](http://ideditor.com/) is a collaborative project with [source\ncode available on GitHub](https://github.com/openstreetmap/iD). It is\nmainly developed to support the OpenStreetMap project.\n",
            "editing_saving": "# Editing & Saving\n\nThis editor is designed to work primarily online, and you're accessing\nit through a website right now.\n\n### Selecting Features\n\nTo select a map feature, like a road or point of interest, click\non it on the map. This will highlight the selected feature, open a panel with\ndetails about it, and show a menu of things you can do with the feature.\n\nTo select multiple features, hold down the 'Shift' key. Then either click\non the features you want to select, or drag on the map to draw a rectangle.\nThis will draw a box and select all the points within it.\n\n### Saving Edits\n\nWhen you make changes like editing roads, these are\nstored locally until you save them to the server. Don't worry if you make\na mistake - you can undo changes by clicking the undo button, and redo\nchanges by clicking the redo button.\n\nClick 'Save' to finish a group of edits - for instance, if you've completed\nan area of town and would like to start on a new area. You'll have a chance\nto review what you've done, and the editor supplies helpful suggestions\nand warnings if something doesn't seem right about the changes.\n\nIf everything looks good, you can enter a short comment explaining the change\nyou made, and click 'Save' again to post the changes\nto [OpenRoads](http://www.openroads.ph/), where they are visible\nto all other users and available for others to build and improve upon.\n\nIf you can't finish your edits in one sitting, you can leave the editor\nwindow and come back (on the same browser and computer), and the\neditor application will offer to restore your work.\n",
        ...
        "intro": {
            "navigation": {
                "title": "Navigation",
                "drag": "The main map area shows OpenRoads data on top of a background. You can navigate by dragging and scrolling, just like any web map. **Drag the map!**",
        ...
        "presets": {
            ...
            "fields": {
                ...
                "or_link_direct_population": {
                    ...
                    "placeholder": "Population served by this link directly"
                },
                "or_link_district_gso": {
                    "label": "Link District GSO",
                    "placeholder": "Link District GSO"
                },
                "or_link_indirect_population": {
                    "label": "Link Indirect Population Service",
                    "placeholder": "Population served by this link indirectly"
                },
                "or_link_length": {
                    "label": "Link Length",
                    "placeholder": "Link Length"
                },
                "or_link_name": {
                    "label": "Link Name",
                    "placeholder": "Link Name (if any)"
                },
                "or_lock": {
                    "label": "Lock geometry"
                },
                ...
                "or_section_articulated_truck": {
                    ...
                    "placeholder": "Section Articulated Truck Traffic (veh/day)"
                },
                "or_section_carriageway": {
                    "label": "Section Carraigeway Width",
                    "placeholder": "Section Carraigeway Width"
                },
                "or_section_commune_gso": {
                    "label": "Section Commune GSO",
                    "placeholder": "Section Commune GSO"
                },
                "or_section_delivery_vehicle": {
                    "label": "Section Delivery Vehicle Traffic (veh/day)",
                    "placeholder": "Section Delivery Vehicle Traffic (veh/day)"
                },
                "or_section_four_wheel": {
                    "label": "Section Four Wheel Traffic (veh/day)",
                    "placeholder": "Section Four Wheel Traffic (veh/day)"
                },
                "or_section_heavy_truck": {
                    "label": "Section Heavy Truck Traffic (veh/day)",
                    "placeholder": "Section Heavy Truck Traffic (veh/day)"
                },
                "or_section_lanes": {
                ...
                "or_section_large_bus": {
                    ...
                    "placeholder": "Section Large Bus Traffic (veh/day)"
                },
                "or_section_length": {
                ...
                "or_section_light_truck": {
                    ...
                    "placeholder": "Section Light Truck Traffic (veh/day)"
                },
                "or_section_medium_bus": {
                    "label": "Section Medium Bus Traffic (veh/day)",
                    "placeholder": "Section Medium Bus Traffic (veh/day)"
                },
                "or_section_medium_car": {
                    "label": "Section Medium Car Traffic (veh/day)",
                    "placeholder": "Section Medium Car Traffic (veh/day)"
                },
                "or_section_medium_truck": {
                    "label": "Section Medium Truck Traffic (veh/day)",
                    "placeholder": "Section Medium Truck Traffic (veh/day)"
                },
                "or_section_moisture": {
                ...
                "or_section_motorcycle": {
                    ...
                    "placeholder": "Section Motorcycle Traffic (veh/day)"
                },
                "or_section_name": {
                    "label": "Section Name",
                    "placeholder": "Section Name (if any)"
                },
                "or_section_pavement": {
                ...
                "or_section_pavement_age": {
                    ...
                    "placeholder": "Section Pavement Age (Years)"
                },
                ...
                "or_section_sequence": {
                    ...
                    "placeholder": "Section Sequence Number"
                },
                "or_section_small_bus": {
                    "label": "Section Small Bus Traffic (veh/day)",
                    "placeholder": "Section Small Bus Traffic (veh/day)"
                },
                "or_section_small_car": {
                    "label": "Section Small Car Traffic (veh/day)",
                    "placeholder": "Section Small Car Traffic (veh/day)"
                },
                "or_section_surface": {
